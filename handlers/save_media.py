...
async def SaveBatchMediaInChannel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Abin_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Open Link", url=share_link)],
                 [InlineKeyboardButton("Join group for latest movies", url="https://t.me/filmboxcommunity"),
                  InlineKeyboardButton("Developer", url="https://t.me/Abintply")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
...
async def SaveMediaInChannel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Abin_{str_to_b64(file_er_id)}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Open Link", url=share_link)],
                 [InlineKeyboardButton("Join group for latest movies", url="https://t.me/filmboxcommunity"),
                  InlineKeyboardButton("Developer", url="https://t.me/Abin")]]
            ),
            disable_web_page_preview=True
        )
    except FloodWait as sl:
